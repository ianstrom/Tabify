...
function FeaturedTablature({ user, setProjectToView, featuredTabs }) {
    ...
    return (
        <div style={{ height: 'auto' }} className='h-full max-w-full mx-auto flex flex-col border rounded-md mb-10 flex-grow'>
            <h1 onClick={handleClick} className="text-4xl mx-auto md:text-6xl cursor-pointer mb-4 ml-6 mt-2 transition duration-300 ease-in-out transform hover:-translate-y-1 hover:text-indigo-700 hover:scale-105">Featured Projects</h1>
