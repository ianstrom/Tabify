        ...
        <div style={{background: "linear-gradient(140.6deg, #052331 55%, #004c3f 100.2%)"}} class="min-h-screen overflow-y-scroll text-white flex flex-row gap-3">
            ...
            <div>
                <Routes>
                    ...
                    <Route path="/edit_project/:id" element={<EditProject setFeaturedTabs={setFeaturedTabs} setUser={setUser} userTabs={userTabs} setUserTabs={setUserTabs} setProjectToView={setProjectToView} project={projectToView} />} />
